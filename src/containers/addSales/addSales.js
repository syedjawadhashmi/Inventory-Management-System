...
class sales extends Component {
    ...
    handleSignup = (e) => {
        ...
        currentState.role = "sales";
        currentState.type = "sales";
            ...
            <div className='Login' style={{marginLeft: '340px',marginTop: '67px',width: '50%'}}>
                <Paper className='Login-Panel'>
                    <form style={{padding: '16px',margin:'0px'}} className='LoginForm'  onSubmit={this.handleSignup}>
                        ...
                        <DatePicker
                            hintText="Sales Date" value={this.state.startDate}  onChange={this._handleStartDate}  mode="landscape" />
...
export default connect(mapStateToProps, reportsActions)(sales);